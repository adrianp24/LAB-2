...
class Display:
    ...
    def reset(self):
        print(f"in {type(self).__name__}")

    def showNumber(self, number):
        print(f" in {type(self).__name__}")

    def showCounterText(self, text):
        print(f" in {type(self).__name__}")
...
class LCDDisplay(Display):
    ...
    def showCounterText(self, text, row=0, col=0):
        """
        Show a string - only first 4 characters will be shown
        for anything bigger than 4 characters.
        """
...
class MorseDisplay(Display):
    ...
    def showNumber(self, number):
        ...
        showCounterText(self, str(number))
    ...
    def showCounterText(self, text):
        ...
        if self._dp is not None:
            self._dp.showCounterText(morse)
